...
if __name__ == "__main__":
    ...
    json_result = compare_shex_files(
        file_path1=r"C:\Users\Usuario\OneDrive - Universidad de Oviedo\papers\yasunori\datasets\t0_samp_results\t0_sampling_results\single_file_no_threshold.shex",
        # file_path2=r"C:\Users\Dani\repos_git\consolidator-shex\result_pdb_100000_v4.shex")
        # file_path2=r"C:\Users\Usuario\repos_git\shex-consolidator\shex_results\result_pdb_{}_files_t0.shex".format(n_files))
        file_path2=r"C:\Users\Usuario\OneDrive - Universidad de Oviedo\papers\yasunori\datasets\t0_samp_results\t0_sampling_results\instances_cap_{}_pdb_t0.shex".format(instances_cap))

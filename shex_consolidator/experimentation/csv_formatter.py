...
def _write_different_const(out_stream, json_stats, separator):
...
def _write_detailed_stats(out_stream, json_stats, separator):
...
def _write_main_stats(out_stream, json_stats, separator):
...
def _write_title(stream, title):
    stream.write(title + "\n")

def _new_file_section(stream):
    stream.write("\n\n")

def json_to_csv (file_path: str, file_title:str, json_stats:dict, separator=";", write_diff_const=True):
